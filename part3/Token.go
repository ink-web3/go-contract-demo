...
func (_Token *TokenCaller) GetTotal(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "getTotal")
...
//
// Solidity: function getTotal() view returns(uint256)
func (_Token *TokenSession) GetTotal() (*big.Int, error) {
	return _Token.Contract.GetTotal(&_Token.CallOpts)
}

// GetTotal is a free data retrieval call binding the contract method 0x775a25e3.
//
// Solidity: function getTotal() view returns(uint256)
func (_Token *TokenCallerSession) GetTotal() (*big.Int, error) {
	return _Token.Contract.GetTotal(&_Token.CallOpts)
}
